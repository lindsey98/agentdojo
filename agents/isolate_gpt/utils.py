"""Utility functions for IsolateGPT LangGraph agent."""
...
def bind_tools(
    ...
    Args:
        llm: The language model instance (ChatOpenAI, ChatAnthropic, or ChatGoogleGenerativeAI).
        tools: List of tools to bind.
        enable_parallel_tool_calls: Whether to enable parallel tool calls.
        tool_call_only: Whether to force tool calls only (no plain text responses).
