"""CaMeL agent with security policies enabled."""
...
def create_agent(
    ...
    **kwargs: Any,
    ...
    """Create CaMeL agent with security policies enabled (NORMAL mode).
    ...
    Returns:
        AgentPipeline configured with CaMeL defense and security policies
    """
    kwargs.setdefault("use_security_policies", True)
    kwargs.setdefault("eval_mode", MetadataEvalMode.NORMAL)
