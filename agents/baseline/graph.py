"""Baseline ReAct agent for AgentDojo using LangGraph.

This module provides the main entry point for loading the baseline agent
in AgentDojo. It wraps the core react_agent_creation logic with an
AgentDojo-compliant interface.
"""
...
def create_agent(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        >>> agent = load_agent("baseline", model="gpt-4o-mini", tools=[...])
