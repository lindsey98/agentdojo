...
def get_user_info(
    account: Annotated[UserAccount, Depends("user_account"), InjectedToolArg],
) -> dict[str, str]:
    """
...
def update_password(account: Annotated[UserAccount, Depends("user_account"), InjectedToolArg], password: str) -> dict[str, str]:
    """
