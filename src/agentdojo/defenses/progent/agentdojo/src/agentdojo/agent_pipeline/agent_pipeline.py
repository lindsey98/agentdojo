...
from agentdojo.agent_pipeline.llms.bedrock_anthropic_llm import BedrockAnthropicLLM
...
from agentdojo.agent_pipeline.llms.secalign_local_llm import LocalLLM
...
def get_llm(provider: str, model: str) -> BasePipelineElement:
    ...
    elif provider in {"aws", "bedrock", "aws-bedrock"}:
        client = boto3.client(
            service_name="bedrock-runtime",
            region_name=os.getenv("AWS_REGION", "us-east-1"),
        )
        llm = BedrockAnthropicLLM(client, model)
